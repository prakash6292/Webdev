      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1>All Category <a href="add_category.php" class="btn btn-secondary">Add New</a></h1>
              </div>
              <div class="col-sm-6">
                    ...
                    <table id="category_table" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="center">
                            <a href="edit_category.php?edit_id=<?php echo $category['id']; ?>" class="btn btn-primary">
                              <i class="nav-icon fa fa-edit"></i>
                            </a>
                            <a onclick="return checkdelete()" href="display_category.php?delete_id=<?php echo $category['id']; ?>" class="btn btn-danger ml-3">
